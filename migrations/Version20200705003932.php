 ...
 */
final class Version20200705003932 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE docs (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, type VARCHAR(255) NOT NULL, taille VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, date_edition DATETIME NOT NULL, date_echeance DATETIME NOT NULL, INDEX IDX_51572BB7FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
